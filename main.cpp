...
int main(int argc, char **argv)
{
    ...
    tiles[Tile::WALL] = std::string("../resources/lost_dung/test_wall.png");
    tiles[Tile::FLOOR] = std::string("../resources/lost_dung/test_floor.png");
    tiles[Tile::TRAP] = std::string("../resources/lost_dung/tile000.png");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        //glDrawPixels(200, 200, GL_RGBA, GL_UNSIGNED_BYTE, img.Data());
        GL_CHECK_ERRORS;
